...
-- Inserção de 30 registros na tabela estabelecimento com CNPJs únicos
INSERT INTO estabelecimento (cnpj, razaosocial, nomefantasia)
VALUES
...
SELECT
    e.nomefantasia AS "Estabelecimento",
    p.nome AS "Projeto",
    pr.nome AS "Produto"
FROM
    estabelecimento e
